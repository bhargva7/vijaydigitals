...
import EcommerenceCarousel from '../components/Ecommerence-carousel'
import CaptchaComponent from '../components/form'; // Your CAPTCHA component
...
const Ecommerce = () => {
  const [formData, setFormData] = useState({
    ...
    subject: '',
    phone: '',
    service: ' Ecommerce Website Designing',
    message: '',
  ...
  return (
    <div>
      <Header />
      <section className="page-title wow fadeIn" style={{ backgroundImage: 'url(images/background/e-commerce.jpg)' }}>
        <div className="auto-container">
          <div className="title-outer">
            <h1 className="title">Ecommerce Website Designing</h1>
            ...
            <div className="image-column col-lg-6 col-md-12 wow fadeInLeft">
              <div className="inner-column">
                <div className="image-box">
                  ...
                  <figure className="image image-1"><img src="images/resource/thumb-10.jpg" alt=" " /></figure>
                </div>
              </div>
            </div>
            <div className="testimonial-column col-lg-6 col-md-12 wow fadeInRight">
              <div className="inner-column">
                <div className="sec-title">
                  <h2>Create a Website that conveys the Uniqueness of your Business and Accelerate Online Sales.</h2>
                </div>
                <div className="testimonial-block-two">
                  <div className="inner-box">
                    <div className="image-box">
                      <div className="text" align="justify">
                        Initiate your online sales journey with a meticulously crafted and customized E-Commerce Website. Our experience spans various clients from diverse sectors globally. As leading E-Commerce Web Designers, our approach transcends mere website creation. We begin by analyzing the nature of your business, your marketing strategies, competitive landscape, and your business objectives, all of which are essential for constructing a successful E-Commerce Platform.
                      </div>
                    </div>
                  </div>
                </div>
      ...
      {/* Services Section */}
      <section className="services-section-two wow fadeInUp">
        <div className="bg bg-pattern-10"></div>
        <div className="auto-container">
          <div className="upper-box row">
            <div className="left-column col-lg-12 col-md-12 wow fadeInUp">
              <div className="sec-title light">
                <span className="">What We’re Offering?</span>
                <h2>Reasons Why We are the Best E-Commerce Website Design Company</h2>
              </div>
            </div>
          </div>
                    ...
                    <div className="row">
                      ...
                      >
                        <select
                          name="service"
                          className="form-control"
                          value={formData.service} // Always set to "Ecommerce Website Designing"
