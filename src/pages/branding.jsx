...
const Branding = () => {
 ...
 return (
    <div>
      ...
      {/* Page Title Section */}
      <section className="page-title wow fadeIn" style={{ backgroundImage: 'url(images/background/branding.jpg)' }}>
        <div className="auto-container">
          <div className="title-outer">
            <h1 className="title">Branding Services</h1>
            ...
            <div className="image-column col-lg-6 col-md-12">
              <div className="inner-column">
                <div className="image-box">
                  ...
                  <figure className="image image-4"><img src="images/resource/thumb-29.jpg" alt="Branding Concept 1" /></figure>
                  <figure className="image image-3"><img src="images/resource/thumb-27.jpg" alt="Branding Concept 2" /></figure>
                  <figure className="image image-2"><img src="images/resource/thumb-28.jpg" alt="Branding Concept 3" /></figure>
                  <figure className="image image-1"><img src="images/resource/thumb-30.jpg" alt="Branding Concept 4" /></figure>
                </div>
              </div>
            </div>
                  ...
                  <div className="inner-box">
                    <div className="image-box">
                      ...
                      <div className="text" align="justify">
                        We are living in a decade of innovations and changes. Can you imagine a man without a digital device or social media? It is complicated right and that’s the reason for everything emerging in the digital medium. <br />
                        Technology has created a big impact and scope in all our daily life activities as a result it opened the door to a whole new era of Business Digital Advertising. <br />
                        Digital Marketing is a modern, advanced, and effective marketing strategy to promote products, services &amp; brands via one or more forms of online or electronic media.
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="row">
                      ...
                      >
                        <select
                          name="service"
                          className="form-control"
                          value={formData.service} // Always set to "Branding"
                          onChange={handleChange}
                          disabled // Disable the dropdown as no other service is available
                        >
                          <option value="Branding">Branding Service</option>
                        </select>
                      </div>
                    </div>
