...
import $ from 'jquery';
  ...
  const Enquiry = () => {
    ...
    return (
        ...
        <section className="page-title" style={{ backgroundImage: 'url(images/background/enquiry.jpg)' }}>
                      ...
                      <div className="row mt-3">
                        ...
                        >
                          <div className="input-group">
                            ...
                            <input
                              name="phone"
                              className="form-control ms-2"style={{width:'10px'}}
                              type="text"
                      ...
                      <div className="row">
                        ...
                        >
                          ...
                          >
                            ...
                            <option value="Static Web Design">Static Web Design Service</option>
                            <option value="Dynamic Web Development">Dynamic Web Development Service</option>
                            <option value="Ecommerce Web Design">Ecommerce Web Design</option>
                            <option value="Web App Development">Web App Development Service</option>
                            <option value="Android App Development">Android App Development Service</option>
                            <option value="Hybrid App Development">Hybrid App Development Service</option>
                            <option value="Digital Marketing">Digital Marketing Service</option>
                        ...
                        {/* Display error message or apply red border */}
                        {errors.service && (
                          <div className="Note text-danger ">  service is required</div>
                        )}
                      </div>
