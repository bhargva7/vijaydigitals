...
const DynamicWebDevelopmentPage = () => {
  const [formData, setFormData] = useState({
    name: '',
    email: '',
    subject: '',
    phone: '',
    service: ' Dynamic Web Development',
    message: '',
  ...
  return (
    <div>
      <Header />
      <section className="page-title wow fadeIn" style={{ backgroundImage: 'url(images/background/web-dev.jpg)' }}>
        <div className="auto-container">
          <div className="title-outer">
            <h1 className="title">Dynamic Web Development</h1>
            ...
            <div className="image-column col-lg-6 col-md-12 wow fadeInLeft">
              <div className="inner-column">
                <div className="image-box">
                  <figure className="image image-4"><img src="images/resource/thumb-8.jpg" alt="" /></figure>
                  <figure className="image image-3"><img src="images/resource/thumb-7.jpg" alt="" /></figure>
                  <figure className="image image-2"><img src="images/resource/thumb-9.jpg" alt="" /></figure>
                  <figure className="image image-1"><img src="images/resource/thumb-6.jpg" alt="" /></figure>
                </div>
              </div>
            </div>
            <div className="testimonial-column col-lg-6 col-md-12 wow fadeInRight">
              <div className="inner-column">
                <div className="sec-title">
                  <h2>Get Your Website Developed <br />by the Experts</h2>
                </div>
                <div className="testimonial-block-two">
                  <div className="inner-box">
                    <div className="text">In today's world, when your website needs frequent updates, it makes sense to have a Dynamic Website because of its easy management.</div>
                    <div className="text" align="justify">
                      With a dynamic website, you don't have to call your website service provider every time you need a modification, like updating or deleting content. There are many more awesome benefits of a dynamic website!
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="features-section-three wow fadeInUp">
        ...
        <div className="auto-container">
          <div className="row">
            <div className="title-column col-xl-6 col-lg-12 col-md-12 col-sm-12 wow fadeInUp">
              <div className="inner-column">
                <div className="sec-title light">
                  <span className="">Benefits</span>
                  <h2>Benefits of Dynamic Web Design</h2>
                  <div className="text">
            ...
            <div className="features-column col-xl-6 col-lg-12 col-md-12 wow fadeInUp">
              <div className="row">
                <div className="feature-block-three col-lg-6 col-md-6 wow fadeInRight">
                  <div className="inner-box">
                    <div className="content">
                      ...
                      <h6 className="title">Better User Engagement</h6>
                    </div>
                  </div>
                </div>
                <div className="feature-block-three col-lg-6 col-md-6 wow fadeInRight">
                  <div className="inner-box">
                    <div className="content">
                      <span className="icon"><i className="fa fa-browsers"></i></span>
                      <h6 className="title">Easy Analysis and Reporting</h6>
                    </div>
                  </div>
                </div>
                <div className="feature-block-three col-lg-6 col-md-6 wow fadeInRight">
                  <div className="inner-box">
                    <div className="content">
                      <span className="icon"><i className="fa fa-list-check"></i></span>
                      <h6 className="title">Better SEO</h6>
                    </div>
                  </div>
                </div>
                <div className="feature-block-three col-lg-6 col-md-6 wow fadeInRight">
                  <div className="inner-box">
                    <div className="content">
                      <span className="icon"><i className="fab fa-laptop"></i></span>
                      <h6 className="title">Lower Bounce Rate</h6>
                    </div>
                  </div>
                </div>
                <div className="feature-block-three col-lg-6 col-md-6 wow fadeInRight">
                  <div className="inner-box">
                    <div className="content">
                      ...
                      <h6 className="title">Advanced Integration</h6>
                    </div>
                  </div>
                </div>
                <div className="feature-block-three col-lg-6 col-md-6 wow fadeInRight">
                  <div className="inner-box">
                    <div className="content">
                      ...
                      <h6 className="title">You Get a CMS</h6>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="contact-section pt-0 pb-0 wow fadeInUp">
        <div className="auto-container">
          <div className="row">
                    ...
                    <div className="row">
                      ...
                      >
                        <select
                          name="service"
                          className="form-control"
                          value={formData.service} // Always set to "Dynamic Web Development"
                          onChange={handleChange}
                          disabled // Disable the dropdown as no other service is available
                        >
                          <option value="Dynamic Web Development">Dynamic Web Development</option>
                        </select>
                      </div>
                    </div>
            ...
            <div className="image-column col-lg-6 col-md-12 wow fadeInRight">
              <div className="inner-column">
...
export default DynamicWebDevelopmentPage;
