...
const Staticweb = () => {
  ...
  return (
    <div>
      <Header />
      <section className="page-title wow fadeIn" style={{ backgroundImage: 'url(images/background/static-webdesign.jpg)' }}>
        <div className="auto-container">
          <div className="title-outer">
            <h1 className="title">Static Web Design</h1>
                    ...
                    <div className="row">
                      ...
                      >
                        <select
                          name="service"
                          className="form-control"
                          value={formData.service} // Always set to "Static Web Design"
